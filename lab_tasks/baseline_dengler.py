...
class BaselineDengler(Basetask):
    ...
    def get_observations(self):
        ...
        self.ee_pose = ee_pose.clone().to(self.device)
    ...
    def apply_action(self):
        ...
        self.measured_effort = self.articulation_prim.get_measured_joint_forces()[:, [self.articulation_prim.get_joint_index("end_effector") + 1]]  #FixedJoint / end_effector
        ...
        self.logging_data = {
            ...
            "contact_force": self.ee_efforts.cpu().numpy().tolist(),
        }
