...
class AdmiPush2(Basetask):
    ...
    def process_actions(self, actions): 
        ...
        F_command = th.tensor([[ee_pose[0][0] + Fxy[0][0],ee_pose[0][1] + Fxy[0][1], 0]], device = self.device)
    ...
    def apply_action(self):
        ...
        ee_fpart_vel = self.estimate_obj_velocity(self.sim_dt, ee_fpart_pos[:,0:2])
        ...
        self.admittance_controller.set_delta_pos(ee_fpart_pos)
        self.admittance_controller.set_delta_vel(ee_fpart_vel)
