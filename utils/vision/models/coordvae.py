...
from utils.vision.models.utils.coord_conv import CoordConv, CoordConvTranspose
...
class CoordVAE(nn.Module):
    def __init__(self,  device=None, input_dim = None, latent_dim = None):
        ...
        self.encoder_1 = nn.Sequential(
            CoordConv(input_dim, 32, kernel_size = 3, padding = 1, stride=2 ), 
            nn.BatchNorm2d(32),
            nn.LeakyReLU(0.2),
        ...
        self.decoder_1 = nn.Sequential(
            CoordConvTranspose(128, 64, kernel_size = 3, padding = 1, stride=2), # deconv1
            nn.BatchNorm2d(64),
            nn.LeakyReLU(0.2),
            CoordConvTranspose(64, 64, kernel_size = 3,  stride=2), # deconv3
            nn.BatchNorm2d(64),
            nn.LeakyReLU(0.2),
            CoordConvTranspose(64, 32, kernel_size = 3,  stride=2), # deconv4
            nn.BatchNorm2d(32),
            nn.LeakyReLU(0.2),
            CoordConvTranspose(32, self.input_dim,  kernel_size = 2, stride=1), 
        )
